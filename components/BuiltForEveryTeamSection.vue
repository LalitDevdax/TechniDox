  ...
  >
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
        ...
        <!-- Card 1: Open Source Teams -->
        <div class="bg-white border border-[#868585] rounded-xl sm:rounded-2xl py-5 px-5 sm:py-7 sm:px-8 flex flex-col justify-between shadow-[0_0_20px_10px_rgba(0,0,0,0.05)]">
          <div>
            <!-- Header Row -->
          ...
          <div>
            ...
            <div class="flex items-start gap-4 mb-4">
              ...
              <div>
                ...
                <h3 class="text-[18px] font-normal text-slate-900 leading-snug">
                  Onboard developers 2.3x faster
                </h3>
              </div>
            </div>
          ...
          <div>
            ...
            <div class="flex items-start gap-4 mb-4">
              ...
              <div>
                ...
                <h3 class="text-[18px] font-normal text-slate-900 leading-snug">
                  Documentation that scales with your APIs
                </h3>
              </div>
            </div>
        ...
        <!-- Card 4: Enterprise Documentation -->
        <div class="bg-brand-primary rounded-xl sm:rounded-2xl py-5 px-5 sm:py-7 sm:px-8 flex flex-col justify-between text-white shadow-[0_0_20px_10px_rgba(0,0,0,0.05)]">
          <div>
            <!-- Header Row -->
            <div class="flex items-start gap-4 mb-4">
